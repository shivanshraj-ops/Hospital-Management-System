...
$("loginForm").onsubmit = async function (e) {
  ...
  var res = await apiRequest("api/login.php", "POST", {
    username: u,
    password: p
  });
...
$("signupForm").onsubmit = async function (e) {
  ...
  var res = await apiRequest("api/signup.php", "POST", {
    fullName: fullName,
    email: email,
    age: Number(age),
    password: password,
...
function openForgotPasswordEmailStep() {
  ...
  $("fpEmailForm").onsubmit = async function (e) {
    ...
    var res = await apiRequest("api/forgot-password.php", "POST", {
...
async function loadDashboard() {
  var res = await apiRequest("api/dashboard.php");
...
async function updateApptStatus(selectEl) {
  ...
  var res = await apiRequest("api/appointments.php", "PUT", { id: id, status: newStatus });
...
async function loadPatients() {
  ...
  var url = "api/patients.php?search=" + encodeURIComponent(q) + "&status=" + encodeURIComponent(f);
...
async function patientForm(id) {
  ...
  if (!doctors.length) {
    var docRes = await apiRequest("api/doctors.php");
  ...
  $("pForm").onsubmit = async function (e) {
    ...
    var res = await apiRequest("api/patients.php", id ? "PUT" : "POST", record);
    if (res && res.success) {
      closeModal();
      loadPatients();
      loadDashboard();
...
async function deletePatient(id) {
  ...
  var res = await apiRequest("api/patients.php", "DELETE", { id: id });
  if (res && res.success) {
    loadPatients();
    loadDashboard();
...
async function loadDoctors() {
  ...
  var url = "api/doctors.php?search=" + encodeURIComponent(q) + "&status=" + encodeURIComponent(f);
  var res = await apiRequest(url);
...
function doctorForm(id) {
  ...
  $("dForm").onsubmit = async function (e) {
    ...
    var res = await apiRequest("api/doctors.php", id ? "PUT" : "POST", record);
    if (res && res.success) {
      closeModal();
      loadDoctors();
      loadDashboard();
...
async function deleteDoctor(id) {
  ...
  var res = await apiRequest("api/doctors.php", "DELETE", { id: id });
  if (res && res.success) {
    loadDoctors();
    loadDashboard();
...
async function bookAppointmentForm() {
  ...
  $("bkForm").onsubmit = async function (e) {
    ...
    var res = await apiRequest("api/appointments.php", "POST", record);
...
async function loadBills() {
  ...
  var url = "api/invoices.php?search=" + encodeURIComponent(q) + "&status=" + encodeURIComponent(f);
  var res = await apiRequest(url);
...
async function togglePaid(id) {
  var res = await apiRequest("api/invoices.php", "PUT", { id: id, toggle_status: true });
  if (res && res.success) {
    loadBills();
    loadDashboard();
    toast(res.message);
...
function billForm(id) {
  ...
  $("bForm").onsubmit = async function (e) {
    ...
    var res = await apiRequest("api/invoices.php", id ? "PUT" : "POST", record);
    if (res && res.success) {
      closeModal();
      loadBills();
      loadDashboard();
...
async function deleteBill(id) {
  ...
  var res = await apiRequest("api/invoices.php", "DELETE", { id: id });
  if (res && res.success) {
    loadBills();
    loadDashboard();
...
async function loadStaff() {
  ...
  var url = "api/staff.php?search=" + encodeURIComponent(q) + "&status=" + encodeURIComponent(f);
  var res = await apiRequest(url);
...
function staffForm(id) {
  ...
  $("sForm").onsubmit = async function (e) {
    ...
    var res = await apiRequest("api/staff.php", id ? "PUT" : "POST", record);
    if (res && res.success) {
      closeModal();
      loadStaff();
...
async function deleteStaff(id) {
  ...
  var res = await apiRequest("api/staff.php", "DELETE", { id: id });
  if (res && res.success) {
    loadStaff();
    toast("Staff deleted");
  } else {
...
if (contactFormEl) {
  contactFormEl.onsubmit = async function (e) {
    ...
    var res = await apiRequest("api/contacts.php", "POST", {
      name: name,
      email: email,
      subject: subject,
      message: message
...
if ($("acctPhotoInput")) {
  $("acctPhotoInput").onchange = function (e) {
    ...
    reader.onload = async function (evt) {
      ...
      var res = await apiRequest("api/session.php", "POST", {
        action: "update_photo",
        photo: dataUrl
      });
